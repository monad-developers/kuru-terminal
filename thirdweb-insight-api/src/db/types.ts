...
export type KuruEvent = TradeEvent | OrderCreatedEvent | OrdersCanceledEvent | OwnershipHandoverCanceledEvent | OwnershipHandoverRequestedEvent | OwnershipTransferredEvent | UpgradedEvent | InitializedEvent;
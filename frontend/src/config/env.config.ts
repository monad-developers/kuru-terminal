...
const ENV_VARS = {
    ...
    "NEXT_PUBLIC_THIRDWEB_INSIGHT_WS_URL": process.env.NEXT_PUBLIC_THIRDWEB_INSIGHT_WS_URL,
...
export const THIRDWEB_INSIGHT_WS_URL = getEnvOrThrow("NEXT_PUBLIC_THIRDWEB_INSIGHT_WS_URL");
